...
// jsonに出力する
file_put_contents('/home/molihua717/bitcoin-chart.info/public_html/js/json/zaif.json', $zaif_array);
file_put_contents('/home/molihua717/bitcoin-chart.info/public_html/js/json/bitflyer.json', $bitflyer_array);
file_put_contents('/home/molihua717/bitcoin-chart.info/public_html/js/json/coincheck.json', $coincheck_array);
